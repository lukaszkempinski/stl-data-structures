...
// configuration step. It creates a namespace called `stl_data_structures`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", stl_data_structures::cmake::project_name, stl_data_structures::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", stl_data_structures::cmake::project_version);
      return EXIT_SUCCESS;
    }
